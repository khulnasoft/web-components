...
func TestMultiSearch(t *testing.T) {
	...
	_, err := typosearchClient.Collection(collectionName1).Documents().Import(context.Background(), documents, params)
	require.NoError(t, err)

	_, err = typosearchClient.Collection(collectionName2).Documents().Import(context.Background(), documents, params)
	require.NoError(t, err)
	...
	result, err := typosearchClient.MultiSearch.Perform(context.Background(), searchParams, searches)
	require.NoError(t, err)
...
func TestMultiSearchVectorQuery(t *testing.T) {
	_, err := typosearchClient.Collection("embeddings").Delete(context.Background())
	...
	_, err = typosearchClient.Collections().Create(context.Background(), &collSchema)
	require.NoError(t, err)
	...
	_, err = typosearchClient.Collection("embeddings").Documents().Create(context.Background(), vecDoc, &api.DocumentIndexParameters{})
	require.NoError(t, err)
	...
	searchResp, err := typosearchClient.MultiSearch.Perform(context.Background(), searchParams, searches)
	require.NoError(t, err)
...
func TestMultiSearchWithPreset(t *testing.T) {
	...
	_, err = typosearchClient.Presets().Upsert(context.Background(), presetName, preset)
	require.NoError(t, err)
	...
	result, err := typosearchClient.MultiSearch.Perform(context.Background(), searchParams, api.MultiSearchSearchesParameter{})
	require.NoError(t, err)
...
func TestMultiSearchWithStopwords(t *testing.T) {
	...
	_, err = typosearchClient.Stopwords().Upsert(context.Background(), stopwordsSetID, upsertData)
	require.NoError(t, err)
