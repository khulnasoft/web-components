...
func TestCollectionSearch(t *testing.T) {
	...
	_, err := typosearchClient.Collection(collectionName).Documents().Import(context.Background(), documents, params)
	...
	result, err := typosearchClient.Collection(collectionName).Documents().Search(context.Background(), searchParams)
...
func TestCollectionGroupByStringArray(t *testing.T) {
	collectionName := "tags"
	_, err := typosearchClient.Collection(collectionName).Delete(context.Background())
	...
	_, err = typosearchClient.Collections().Create(context.Background(), schema)
	require.NoError(t, err)
...
func TestCollectionSearchWithPreset(t *testing.T) {
	...
	result, err := typosearchClient.Collection(collectionName).Documents().Search(context.Background(), &api.SearchCollectionParams{
		Preset: &presetName,
	})
