...
func TestAnalyticsRuleRetrieve(t *testing.T) {
	...
	result, err := typosearchClient.Analytics().Rule(expectedRule.Name).Retrieve(context.Background())
...
func TestAnalyticsRuleDelete(t *testing.T) {
	...
	result, err := typosearchClient.Analytics().Rule(expectedRule.Name).Delete(context.Background())
