...
func TestDocumentsImport(t *testing.T) {
	...
	responses, err := typosearchClient.Collection(collectionName).Documents().Import(context.Background(), documents, params)
...
func TestDocumentsImportJsonl(t *testing.T) {
	...
	responses, err := typosearchClient.Collection(collectionName).Documents().ImportJsonl(context.Background(), &buffer, params)
