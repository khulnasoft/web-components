...
#
# Build:
#   docker build -t typosearch/typosearch-clion-remote-cpp-env-arm:11-OCT-2022-1 -f ./docker/clion-remote-cpp-env-arm.Dockerfile ./docker
#   docker push typosearch/typosearch-clion-remote-cpp-env-arm:11-OCT-2022-1
#
# Run:
#   docker run -d --cap-add sys_ptrace -v`pwd`/typosearch-server-data/:/var/lib/typosearch -p 127.0.0.1:2222:22 -p 127.0.0.1:8108:8108 --name clion_remote_env typosearch/typosearch-clion-remote-cpp-env-arm:11-OCT-2022-1
...
FROM typosearch/typosearch-development-arm:27-JUN-2022-1
