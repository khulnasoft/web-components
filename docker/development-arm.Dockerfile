# docker build --file ./docker/development-arm.Dockerfile --tag typosearch/typosearch-development-arm:03-DEC-2021-1 ./docker
# 
# $ docker push typosearch/typosearch-development-arm:03-DEC-2021-1
