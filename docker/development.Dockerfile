# docker build --file $PROJECT_DIR/docker/development.Dockerfile --tag typosearch/typosearch-development:latest $PROJECT_DIR/docker
# 
# $ docker push typosearch/typosearch-development:latest

FROM typosearch/ubuntu-12-04-gcc:v10.1.0
