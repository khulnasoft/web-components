...
protected:
    ...
    void setupCollection() {
        std::string state_dir_path = "/tmp/typosearch_test/core_api_utils";
...
TEST_F(CoreAPIUtilsTest, TestProxy) {
    ...
    std::string url = "https://typosearch.org";
...
TEST_F(CoreAPIUtilsTest, TestProxyTimeout) {
    ...
    // test with url as empty string
    body["url"] = "https://typosearch.org/docs/";
    body["method"] = "GET";
    body["headers"] = nlohmann::json::object();
