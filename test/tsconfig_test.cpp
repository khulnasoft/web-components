...
TEST(ConfigTest, LoadEnvVars) {
    cmdline::parser options;
    putenv((char*)"TYPOSEARCH_DATA_DIR=/tmp/ts");
    putenv((char*)"TYPOSEARCH_LISTEN_PORT=9090");
    ConfigImpl config;
...
TEST(ConfigTest, CmdLineArgsOverrideConfigFileAndEnvVars) {
    ...
    putenv((char*)"TYPOSEARCH_DATA_DIR=/tmp/ts");
    putenv((char*)"TYPOSEARCH_LOG_DIR=/tmp/ts_log");
    putenv((char*)"TYPOSEARCH_LISTEN_PORT=9090");
    putenv((char*)"TYPOSEARCH_LISTEN_ADDRESS=127.0.0.1");
    putenv((char*)"TYPOSEARCH_ENABLE_CORS=TRUE");
    putenv((char*)"TYPOSEARCH_CORS_DOMAINS=http://localhost:7108");
...
TEST(ConfigTest, CorsDefaults) {
    ...
    unsetenv("TYPOSEARCH_ENABLE_CORS");
    unsetenv("TYPOSEARCH_CORS_DOMAINS");
