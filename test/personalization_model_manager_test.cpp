...
protected:
    ...
    void SetUp() override {
        ...
        std::string test_dir = "/tmp/typosearch_test/models";
        system(("rm -rf " + test_dir + " && mkdir -p " + test_dir).c_str());
        EmbedderManager::set_model_dir(test_dir);

        // Create test collection
        std::string state_dir_path = "/tmp/typosearch_test/personalization_model_manager_test";
    ...
    void TearDown() override {
        std::string test_dir = "/tmp/typosearch_test";
