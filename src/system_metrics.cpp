...
void SystemMetrics::get(const std::string &data_dir_path, nlohmann::json &result) {
    ...
    result["typosearch_memory_active_bytes"] = std::to_string(active);
    result["typosearch_memory_allocated_bytes"] = std::to_string(allocated);
    result["typosearch_memory_resident_bytes"] = std::to_string(active);
    result["typosearch_memory_metadata_bytes"] = std::to_string(metadata);
    result["typosearch_memory_mapped_bytes"] = std::to_string(mapped);
    result["typosearch_memory_retained_bytes"] = std::to_string(retained);
    ...
    result["typosearch_memory_fragmentation_ratio"] = frag_ratio;
